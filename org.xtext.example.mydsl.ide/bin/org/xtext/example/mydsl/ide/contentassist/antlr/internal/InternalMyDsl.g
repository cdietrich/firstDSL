...
:
	(
		...
		(
			{ before(grammarAccess.getOperationAccess().getLeftEClassQualifiedNameParserRuleCall_1_0_1()); }
			ruleQualifiedName
			{ after(grammarAccess.getOperationAccess().getLeftEClassQualifiedNameParserRuleCall_1_0_1()); }
		)
...
:
	(
		...
		(
			{ before(grammarAccess.getOperationAccess().getRightEClassQualifiedNameParserRuleCall_3_0_1()); }
			ruleQualifiedName
			{ after(grammarAccess.getOperationAccess().getRightEClassQualifiedNameParserRuleCall_3_0_1()); }
		)
