		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelAccess().getOperationsAssignment_1(), "rule__Model__OperationsAssignment_1");
					put(grammarAccess.getOperationAccess().getLeftAssignment_1(), "rule__Operation__LeftAssignment_1");
					put(grammarAccess.getOperationAccess().getRightAssignment_3(), "rule__Operation__RightAssignment_3");
					put(grammarAccess.getOperationAccess().getConditionAssignment_6(), "rule__Operation__ConditionAssignment_6");
